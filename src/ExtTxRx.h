...
static std::ostream& operator<<(std::ostream& strm, const ExtTxRx::TxStats& data){
  strm << ExtTxRx::tx_stats_to_string(data);
  return strm;
}
static std::ostream& operator<<(std::ostream& strm, const ExtTxRx::RxStats& data){
  strm << ExtTxRx::rx_stats_to_string(data);
  return strm;
}
static std::ostream& operator<<(std::ostream& strm, const ExtTxRx::RxStatsPerCard& data){
  strm << ExtTxRx::rx_stats_per_card_to_string(data);
  return strm;
}
